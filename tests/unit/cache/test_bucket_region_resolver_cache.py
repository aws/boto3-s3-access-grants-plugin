...
class TestBucketRegionResolverCache(unittest.TestCase):
    ...
    @mock.patch('aws_s3_access_grants_boto_plugin.cache.bucket_region_resolver_cache.BucketRegionResolverCache._BucketRegionResolverCache__resolve_from_service')
