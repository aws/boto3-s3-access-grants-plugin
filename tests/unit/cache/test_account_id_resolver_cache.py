...
from aws_s3_access_grants_boto_plugin.cache.account_id_resolver_cache import AccountIdResolverCache
...
class TestAccountIdResolverCache(unittest.TestCase):
    ...
    @mock.patch('aws_s3_access_grants_boto_plugin.cache.account_id_resolver_cache.AccountIdResolverCache._AccountIdResolverCache__resolve_from_service')
