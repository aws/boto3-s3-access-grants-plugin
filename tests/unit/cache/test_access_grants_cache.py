...
from aws_s3_access_grants_boto_plugin.cache.access_denied_cache import AccessDeniedCache
from aws_s3_access_grants_boto_plugin.cache.access_grants_cache import AccessGrantsCache
...
class TestAccessGrantsCache(unittest.TestCase):
    ...
    @mock.patch('aws_s3_access_grants_boto_plugin.cache.access_grants_cache.AccessGrantsCache._AccessGrantsCache__get_credentials_from_service')
